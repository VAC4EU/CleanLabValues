...
test_that("Example 5 with specified datasource matches ground truth", {
  input_dir <- test_path("data", "Example 5", "i_input")
  gt_dir <- test_path("data", "Example 5", "i_ground_truth")
  ...
  expect_true(isTRUE(all.equal(cleaned, gt, check.attributes = FALSE)))
})
